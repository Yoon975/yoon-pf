...
export const projects = [
  ...
  },
  {
    ...
    metrics: null,
    thumbSrc: '/yoon-pf/assets/images/safey/01-features.png',
    heroSrc: '/yoon-pf/assets/images/safey/01-features.png',
    gallery: [
      {
        slot: 'screenshot-1',
        caption: '전체 기능 요약 (Web · App)',
        src: '/yoon-pf/assets/images/safey/01-features.png',
      },
      {
        slot: 'screenshot-2',
        caption: '뷰포트 마커 · 격자/행사/제보 패널 UX',
        src: '/yoon-pf/assets/images/safey/02-marker-panel.png',
      },
      {
        slot: 'screenshot-3',
        caption: 'KOROAD 사고다발구역 4종 · API 호출 최적화',
        src: '/yoon-pf/assets/images/safey/03-koroad.png',
      },
      {
        slot: 'screenshot-4',
        caption: 'Flutter 앱 — 웹 지도 UI·GPS·제보 알림 이식',
        src: '/yoon-pf/assets/images/safey/05-flutter.png',
      },
    ],
  },
  {
