...
export const projects = [
  ...
  },
  {
    ...
    role: [
      ...
      '제보·행사 이미지 업로드 시 OpenCV YuNet(ONNX) 얼굴 자동 마스킹 — 저장 전 서버 처리',
    ...
    metrics: null,
    thumbSrc: '/yoon-pf/assets/images/safey/app-01-grid-safety.png',
    heroSrc: '/yoon-pf/assets/images/safey/app-01-grid-safety.png',
    gallery: [
      {
        slot: 'screenshot-1',
        caption: '앱 · 격자 안전등급·CCTV 클러스터',
        src: '/yoon-pf/assets/images/safey/app-01-grid-safety.png',
      },
      {
        slot: 'screenshot-2',
        caption: '앱 · KOROAD 위험구간 4종 토글',
        src: '/yoon-pf/assets/images/safey/app-02-hazard-zones.png',
      },
      {
        slot: 'screenshot-3',
        caption: '앱 · 행사 마커·상세 패널',
        src: '/yoon-pf/assets/images/safey/app-03-events.png',
      },
      {
        slot: 'screenshot-4',
        caption: '앱 · 보행 길찾기·CCTV·제보 경로',
        src: '/yoon-pf/assets/images/safey/app-04-navigation.png',
      },
    ],
  },
  {
